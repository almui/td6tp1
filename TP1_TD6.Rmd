...
# Matriz de confusión
table(
  Predicho = predictions_class,
  Real = test$es_productivo
)
...
F1_Score(y_true=test$es_productivo, y_pred = predictions_class, positive = NULL)
Precision(y_true=test$es_productivo, y_pred = predictions_class, positive = NULL)
Recall(y_true=test$es_productivo, y_pred = predictions_class, positive = NULL)
AUC(y_pred=predictions_class, y_true=test$es_productivo)
```
